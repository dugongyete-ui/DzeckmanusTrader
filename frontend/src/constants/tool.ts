...
export const TOOL_FUNCTION_MAP: {[key: string]: string} = {
  ...
  "browser_extract_text": "Extracting text",
...
import ExtractTextToolView from '@/components/toolViews/ExtractTextToolView.vue';
...
export const TOOL_FUNCTION_COMPONENT_MAP: {[key: string]: any} = {
  ...
  "browser_extract_text": ExtractTextToolView,
